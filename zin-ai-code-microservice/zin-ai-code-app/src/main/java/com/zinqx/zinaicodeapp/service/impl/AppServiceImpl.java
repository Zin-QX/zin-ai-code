package com.zinqx.zinaicodeapp.service.impl;
...
import com.zinqx.zinaicodeapp.core.AiCodeGeneratorFacade;
import com.zinqx.zinaicodeapp.mapper.AppMapper;
import com.zinqx.zinaicodeapp.service.AppService;
import com.zinqx.zinaicodeapp.service.ChatHistoryService;
...
import com.zinqx.zinaicodemodel.model.entity.ChatHistory;
import com.zinqx.zinaicodemodel.model.entity.User;
import com.zinqx.zinaicodemodel.model.enums.ChatHistoryMessageTypeEnum;
import com.zinqx.zinaicodemodel.model.enums.CodeGenTypeEnum;
import com.zinqx.zinaicodemodel.model.vo.AppVO;
import com.zinqx.zinaicodemodel.model.vo.ChatHistoryVO;
...
//    private UserService userService;
    ...
    @Override
    public AppVO getAppVOWithChatHistory(App app, User loginUser) {
        if (app == null) {
            return null;
        }
        ...
        if (CollUtil.isNotEmpty(chatHistoryList)) {
            ...
            appVO.setChatHistoryList(chatHistoryVOList);
        }
        return appVO;
    }
...
//            queryWrapper.like("deployKey", deployKey);
//        }
//        if (priority != null) {
